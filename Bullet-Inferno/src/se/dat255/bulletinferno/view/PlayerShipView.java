...
public class PlayerShipView implements Renderable, Timerable {
	...
	public PlayerShipView(final PlayerShip ship, ResourceManager resourceManager) {
		...
		explosion = resourceManager.getTexture(GameTextureDefinitionImpl.PLAYER_EXPLOSION);
		...
		smokeTexture = resourceManager.getTexture(GameTextureDefinitionImpl.SMOKE_PARTICLE);
